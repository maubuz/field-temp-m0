...
Tsys01::Tsys01(uint8_t _communicationProtocol, uint8_t _powerPin)
{
  ...
  #if TSYS_DEBUG
    Serial.print("TSYS01: Setting communication protocol: ");
    Serial.println(_communicationProtocol);
  #endif  
...
Tsys01::Tsys01(uint8_t _communicationProtocol, uint8_t _powerPin, uint8_t _slaveSelect, uint8_t _protocolPin)
{
  this->powerPin = _powerPin;
    ...
    #if TSYS_DEBUG
    Serial.print("Seting Power Pin: ");
    Serial.println(_powerPin);
  #endif
  
  this->slaveSelectPin = _slaveSelect;
  #if TSYS_DEBUG
    Serial.print("TSYS01: Chip Select: ");
    Serial.println(_slaveSelect);
  #endif
  ...
  #if TSYS_DEBUG
    Serial.print("TSYS01: Setting protocol pin: ");
    Serial.println(_protocolPin);
  #endif
